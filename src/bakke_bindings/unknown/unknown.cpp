...
;
	...
	{ // Vector file: line:27
		...
		cl.def("__add__", (struct Vector (Vector::*)(struct Vector)) &Vector::operator+, "C++: Vector::operator+(struct Vector) --> struct Vector", pybind11::arg("v2"));
		cl.def("__mul__", (struct Vector (Vector::*)(struct Vector)) &Vector::operator*, "C++: Vector::operator*(struct Vector) --> struct Vector", pybind11::arg("v2"));
		cl.def("__sub__", (struct Vector (Vector::*)(struct Vector)) &Vector::operator-, "C++: Vector::operator-(struct Vector) --> struct Vector", pybind11::arg("v2"));
		cl.def("__div__", (struct Vector (Vector::*)(struct Vector)) &Vector::operator/, "C++: Vector::operator/(struct Vector) --> struct Vector", pybind11::arg("v2"));
		...
		cl.def_static("dot", (float (*)(struct Vector, struct Vector)) &Vector::dot, "C++: Vector::dot(struct Vector, struct Vector) --> float", pybind11::arg("v1"), pybind11::arg("v2"));
		cl.def_static("cross", (struct Vector (*)(struct Vector, struct Vector)) &Vector::cross, "C++: Vector::cross(struct Vector, struct Vector) --> struct Vector", pybind11::arg("v1"), pybind11::arg("v2"));
		cl.def_static("lerp", (struct Vector (*)(struct Vector, struct Vector, float)) &Vector::lerp, "C++: Vector::lerp(struct Vector, struct Vector, float) --> struct Vector", pybind11::arg("v1"), pybind11::arg("v2"), pybind11::arg("t"));
		cl.def_static("slerp", (struct Vector (*)(struct Vector, struct Vector, float)) &Vector::slerp, "C++: Vector::slerp(struct Vector, struct Vector, float) --> struct Vector", pybind11::arg("v1"), pybind11::arg("v2"), pybind11::arg("t"));
	}
	...
	M.def("fixRotator", (float (*)(float)) &fixRotator, "C++: fixRotator(float) --> float", pybind11::arg("newRotation"));
	...
	M.def("fixPitch", (float (*)(float)) &fixPitch, "C++: fixPitch(float) --> float", pybind11::arg("newRotation"));
	...
	{ // Rotator file: line:209
		...
		cl.def("__add__", (struct Rotator (Rotator::*)(struct Rotator)) &Rotator::operator+, "C++: Rotator::operator+(struct Rotator) --> struct Rotator", pybind11::arg("v2"));
		cl.def("__mul__", (struct Rotator (Rotator::*)(struct Rotator)) &Rotator::operator*, "C++: Rotator::operator*(struct Rotator) --> struct Rotator", pybind11::arg("v2"));
		cl.def("__sub__", (struct Rotator (Rotator::*)(struct Rotator)) &Rotator::operator-, "C++: Rotator::operator-(struct Rotator) --> struct Rotator", pybind11::arg("v2"));
		cl.def("__div__", (struct Rotator (Rotator::*)(struct Rotator)) &Rotator::operator/, "C++: Rotator::operator/(struct Rotator) --> struct Rotator", pybind11::arg("v2"));
	}
	{ // POV file: line:237
	...
	{ // Vector2 file: line:261
		...
		cl.def("minus", (struct Vector2 (Vector2::*)(struct Vector2)) &Vector2::minus, "C++: Vector2::minus(struct Vector2) --> struct Vector2", pybind11::arg("other"));
	}
	{ // Vector2F file: line:270
		...
		cl.def("minus", (struct Vector2F (Vector2F::*)(struct Vector2)) &Vector2F::minus, "C++: Vector2F::minus(struct Vector2) --> struct Vector2F", pybind11::arg("other"));
	}
	...
	M.def("VectorToRotator", (struct Rotator (*)(struct Vector)) &VectorToRotator, "C++: VectorToRotator(struct Vector) --> struct Rotator", pybind11::arg("vVector"));

	// RotatorToVector(struct Rotator) file: line:303
	M.def("RotatorToVector", (struct Vector (*)(struct Rotator)) &RotatorToVector, "C++: RotatorToVector(struct Rotator) --> struct Vector", pybind11::arg("R"));
...
;
	...
	{ // Quat file: line:360
		...
		cl.def("__mul__", (struct Quat (Quat::*)(struct Quat)) &Quat::operator*, "C++: Quat::operator*(struct Quat) --> struct Quat", pybind11::arg("q2"));
	}
